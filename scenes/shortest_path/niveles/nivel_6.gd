...
export var minimum_connections = 9
export var number_of_level = 6
...
func _ready():
	...
	var _optimal_path_map_ = ['orange_1','red_1','red_2','red_3','yellow_3','grey_7','lightblue_1','lightblue_2','brown_4','blue_10']
